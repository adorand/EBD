$(function(){
  ...
  // définition des valeurs de la courbe pour permettre le traçage de la courbe
  var d0 = [
  ...
  var d000= [
    [0,0],[1,5],[2,8],[3,8],[4,10],[5,20],[6,2],[7,50],[8,13],[9,11],[10,0],[11,81],[12,40],[13,2],[14,1],[15,0],[16,0]
  ];
  $("#flot-sp1ine").length && $.plot($("#flot-sp1ine"), [
      ...
      ],
      {
        ...
        colors: ["#19b39b", "#644688", "#fff"], //le nombre de couleurs est equivo au nombre de courbes
        xaxis:{
        },
        yaxis: {
          ticks: 4
