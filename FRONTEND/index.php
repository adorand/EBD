...
<head>
    ...
    <link href="css/gn-submenu.css" rel="stylesheet">
    ...
    <section>
        <div class="row" style="margin-top: 3px;">
            <div class="col-md-9">
                                ...
                                <ul class="slides">
                                    <li>
                                        <div class="flex-caption">
                                            <div class="caption-animation">
                                                <div class="caption-1">
                                                    <h1 class="base-slider-bg-color" style="border-radius:10px;">Bienvenue sur EBDonline</h1>
                                                </div>
                                                <div class="caption-2">
                                                    <h3 style="border-radius:10px;">Vous êtes bénis<i class="fa fa-smile"></i></h3>
                                                </div>
                                                <div class="caption-3">
                                                    <a href="javascript:void(0)" class="animated1"><i class="fa fa-globe"></i></a>
                                                    <a href="javascript:void(0)" class="animated2 base-slider-bg-color"><i class="fa fa-graduation-cap"></i></a>
                                                    <a href="javascript:void(0)" class="animated3"><i class="fa fa-university"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex-caption">
                                            <div class="caption-animation">
                                                <div class="caption-1">
                                                    <h1 class="base-slider-bg-color" style="border-radius:10px;">Restez connectés</h1>
                                                </div>
                                                <div class="caption-2">
                                                    <h3 style="border-radius:10px;">Accessible en ligne 24h/24 et 7jrs/7<i class="fa fa-smile"></i></h3>
                                                </div>
                                                <div class="caption-3">
                                                    <a href="javascript:void(0)" class="animated1"><i class="fa fa-thumbs-o-up"></i></a>
                                                    <a href="javascript:void(0)" class="animated2"><i class="fa fa-lock"></i></a>
                                                    <a href="javascript:void(0)" class="animated3"><i class="fa fa-cloud"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex-caption">
                                            <div class="caption-animation">
                                                <div class="caption-1">
                                                    <h1 style="border-radius:10px;">Des questions ?</h1>
                                                </div>
                                                <div class="caption-2">
                                                    <h3 class="base-slider-bg-color" style="border-radius:10px;">Contactez nos supports disponibles 24h/24.<i class="fa fa-smile"></i></h3>
                                                </div>
                                                <div class="caption-3">
                                                    <a href="javascript:void(0)" class="animated1"><i class="fa fa-question-circle"></i></a>
                                                    <a href="javascript:void(0)" class="animated2"><i class="fa fa-meh-o"></i></a>
                                                    <a href="javascript:void(0)" class="animated3"><i class="fa fa-clock-o"></i></a>
                                                    <a href="javascript:void(0)" class="animated4"><i class="fa fa-envelope-o"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                ...
                <!-- Pensees du Jour -->
                <section class="grayarea recent-projects-home topspace30" style="background-color: #3a80c6;margin-top: -1px;padding: 0px;">
                    <div class="tp-bannershadow tp-shadow1" style="width: 100%; left: 0px;"></div>
                    <div class="container">
                        <div class="row" >
                            <h1 class="small text-center topspace0 fontpacifico" style="color:#FFF;"><br>PENSEES DU JOUR</h1>
                            ...
                            <div class="col-md-12">
                                <div class="list_carousel text-center">
                                    ...
                                    <ul id="carousel-projects">
                                        <li onclick="location.href='Pensee-du-Jour/'">
                                            <div class="boxcontainer">
                                                <img src="img/demo/showcase1.jpg" alt="">
                                                <div class="roll">
                                                    <div class="wrapcaption">
                                                        <a href="Pensee-du-Jour/"><i class="icon-eye-open captionicons"></i></a>
                                                ...
                                                <h1><a href="projectdetail.html">AU MILIEU DES AFFLICTIONS</a></h1>
                                                <p>
                                                    <i class="fa fa-edit"></i> Pasteur Pierre Celestin NTOKO
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                ...
                <div style="padding-top:30px;background-color: #3a80c6;">

                    <!-- Theme de l'année -->
                    <h1 class=" box presentation" style="margin-left:20px;margin-right:20px;margin-top:0px;font-size:25px;">
                        <center>Thème de l'année: Ecouter les prédications par thème</center>
                    </h1>
                    <!--  /Theme de l'année -->

                    <!-- Evenements et Mot de bienvenue -->
                    <div class="row" >
                        <section class="col-md-6 carousel carousel-fade slide home-slider topspace20" id="c-slideEvt" data-ride="carousel" data-interval="4500" data-pause="false">
                            ...
                            <div class="carousel-inner">
                                <div class="item active" style="height: 350px;background: url(images/Eglise.jpg);">
                                    <div class="container">
                                        <div class="row">
                                ...
                                <div class="item" style="height: 350px;background: url(img/demo/slide3.jpg);">
                                    <div class="container">
                                        <div class="row">
                        ...
                        <section class="col-md-6 topspace30" style="background-color: #f7f7f7;">
                            <div class="text-center">
                                <h2>Mot de Bienvenue</h2>
                                <span class="meta bottomspace30">Par le <a href="#" title="Posts by Roy Sanders" rel="author">Pasteur Moise</a> <span class="bullet">•</span> 22 Septembre 2016<span class="bullet">•</span></span>
                            </div>
                            <p class="lead">
                                <img src="img/demo/desktop2.png" class="pull-left img-responsive" alt="" style="max-width:180px;">
